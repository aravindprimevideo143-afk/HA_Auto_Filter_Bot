...
BOT_TOKEN = environ.get('BOT_TOKEN', "8225271816:AAFvkDdJePJuo2zVAC4FmWNd_jNgcyK6PIs")    # Bot token from @BotFather
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003237091242")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003237091242")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://HA:v16eCQn14bW7LIbD@cluster0.zxnpnsb.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "HAMOVIES") # Database name (default: cluster)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HAMovies3') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/HAMovies3') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/movie_update_01') # Update channel link for the bot
